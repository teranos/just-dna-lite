...
**⚠️ Research Use Only (RUO):** just-dna-lite is a research tool designed for everything from academic studies (like the ROGEN project) to citizen science and personal self-exploration. Our philosophy is to display *everything*—including PRS scores and community-generated AI modules that may attempt to predict disease probabilities. We believe you have the right to access and explore all of your genomic data, provided you **do not use this tool for any diagnostic or medical decisions.**
